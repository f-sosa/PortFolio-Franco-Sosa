...
import CvFrancoSosaa from "../assets/img/CvFrancoSosa.pdf"
                    ...
                    <Col xs={12} md={6} xl={7}>
                        ...
                        {({ isVisible}) =>
                            <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                               ...
                               <a href={CvFrancoSosaa} download="CvFrancoSosa.pdf"><button>{t("banner.downloadCv")}<ArrowRightCircle size={25} /></button></a>
                            </div>}
                        </TrackVisibility>
                    </Col>
                    <Col xs={12} md={6} xl={5}>
                    <div className="imagen-astronauta">
