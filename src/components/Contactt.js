              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                    <input type="tel" maxLength="12"  value={formDetails.phone} placeholder={t("contactt.phone")} onKeyPress={(e) => { if (!/[0-9]/.test(e.key)) { e.preventDefault();}}} onChange={(e) => onFormUpdate('phone', e.target.value)} required/>
                    </Col>
